...
#define SPATIAL_FORCE_TYPEDEF_ARG(classtype)              \
  typedef typename traitsForce<classtype>::Vector3 Vector3; \
  typedef typename traitsForce<classtype>::Vector4 Vector4; \
  typedef typename traitsForce<classtype>::Vector6 Vector6; \
  typedef typename traitsForce<classtype>::Matrix3 Matrix3; \
  typedef typename traitsForce<classtype>::Matrix4 Matrix4; \
  typedef typename traitsForce<classtype>::Matrix6 Matrix6; \
  typedef typename traitsForce<classtype>::Angular_t Angular_t; \
  typedef typename traitsForce<classtype>::Linear_t Linear_t; \
  typedef typename traitsForce<classtype>::Quaternion_t Quaternion_t; \
  typedef typename traitsForce<classtype>::SE3 SE3; \
  enum {  \
    LINEAR = traitsForce<classtype>::LINEAR,  \
    ANGULAR = traitsForce<classtype>::ANGULAR   \
  }
namespace se3
{

  template<class C> struct traitsForce {}; 
  ...
  protected:
    ...
    SPATIAL_FORCE_TYPEDEF_ARG(Derived_t);
  ...
  public:
    ...
    struct traitsForce< ForceTpl<T, U> >
    {
    ...
    public:
      ...
      SPATIAL_FORCE_TYPEDEF_ARG(ForceTpl);
